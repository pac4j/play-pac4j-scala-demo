...
This **play-pac4j-scala-demo** project is a Play 2.4 Scala project to test the [play-pac4j library](https://github.com/pac4j/play-pac4j) with Facebook, Twitter, form authentication, basic auth, CAS, Google OpenID...  
