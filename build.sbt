...
libraryDependencies ++= Seq(
  ...
  "org.pac4j" % "pac4j-cas" % "1.9.3",
  "org.pac4j" % "pac4j-openid" % "1.9.3" exclude("xml-apis" , "xml-apis"),
  "org.pac4j" % "pac4j-oauth" % "1.9.3",
  "org.pac4j" % "pac4j-saml" % "1.9.3",
  "org.pac4j" % "pac4j-oidc" % "1.9.3" exclude("commons-io" , "commons-io"),
  "org.pac4j" % "pac4j-gae" % "1.9.3",
  "org.pac4j" % "pac4j-jwt" % "1.9.3" exclude("commons-io" , "commons-io"),
  "org.pac4j" % "pac4j-ldap" % "1.9.3",
  "org.pac4j" % "pac4j-sql" % "1.9.3",
  "org.pac4j" % "pac4j-mongo" % "1.9.3",
  "org.pac4j" % "pac4j-stormpath" % "1.9.3",
