...
libraryDependencies ++= Seq(
  ...
  "org.pac4j" % "pac4j-http" % "1.8.0-SNAPSHOT",
  "org.pac4j" % "pac4j-cas" % "1.8.0-SNAPSHOT",
  ...
  "org.pac4j" % "pac4j-sql" % "1.8.0-SNAPSHOT",
  "org.pac4j" % "pac4j-mongo" % "1.8.0-SNAPSHOT",
  "org.pac4j" % "pac4j-stormpath" % "1.8.0-SNAPSHOT",
